            ...
            <li class="p-3 border rounded-md [&>p]:text-sm [&>p]:py-1 font-light">
                ...
                <p><? if($order['payed'] === 'No' and $order['status'] != 'Canceled') : ?>
                    <form id="twispay" action="https://<?= $twispayLive ? "secure.xmoney.com" : "secure-stage.xmoney.com" ?>" method="post" accept-charset="UTF-8" class="">
                        ...
                        <button type="submit" class="flex items-center justify-start w-full gap-2 px-2 py-1 text-sm font-normal text-white bg-green-600 rounded-md md:py-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="text-white" width="26" height="26" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                <path d="M14 12m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" />
                                <path d="M12 9.765a3 3 0 1 0 0 4.47" />
                                <path d="M3 5m0 2a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2z" />
                            </svg>
                            <span>Achită acum <?= number_format($total, 2, ',' ,'.'); ?> lei</span>
                        </button>
                    </form>
                    <? endif ?>
                </p>
