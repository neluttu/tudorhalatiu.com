        ...
        <form method="post" class="w-full">
            ...
            <div class="grid w-full grid-cols-1 mt-10 sm:grid-cols-2 gap-x-4 gap-y-3">
                ...
                <div class="relative self-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="absolute left-1 top-3 stroke-main-color" width="22" height="22" viewBox="0 0 24 24" stroke-width="1.5"  fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        <path d="M5 13a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v6a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2v-6z" />
                        <path d="M11 16a1 1 0 1 0 2 0a1 1 0 0 0 -2 0" />
                        <path d="M8 11v-4a4 4 0 1 1 8 0v4" />
                    </svg>
                    <input type="text" name="email" id="email" value="<?= $user['email'] ?>" readonly class="w-full px-0 py-2 mt-1 text-right text-gray-400 border-b-2 border-gray-200 cursor-default focus:outline-none" autocomplete="NA" />
                </div>
