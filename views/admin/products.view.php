    ...
    <div class="w-full md:-mt-10 md:grow">
        ...
        ?>
            <a href="<?= \Core\Session::getLang(); ?>/admin/product/<?= $product['id']; ?>" class="group">
                ...
                <img src="/public/images/products/<?=$product['id']?>/poster.jpg" alt="Tall slender porcelain bottle with natural clay textured body and cork stopper." class="object-cover object-center w-full h-full group-hover:opacity-75">
                </div>
