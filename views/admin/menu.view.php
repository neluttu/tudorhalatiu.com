...
<a href="/admin/products"
    class="<?= urlIs('/admin/products') ? 'border-b border-[#ed0078] text-[#ed0078]' : '' ?> ">Produse</a>
<a href="/admin/product/create/new"
    class="<?= urlIs('/admin/product/create/new') ? 'border-b border-[#ed0078] text-[#ed0078]' : '' ?> ">Adaugă produs
    nou</a>
<a href="/admin/categories"
    class="<?= urlIs('/admin/categories') ? 'border-b border-[#ed0078] text-[#ed0078]' : '' ?> ">Categorii</a>
<a href="/admin/clienti"
    class="<?= urlIs('/admin/clienti') ? 'border-b border-[#ed0078] text-[#ed0078]' : '' ?> ">Clienti</a>
<a href="/admin/settings"
    class="<?= urlIs('/admin/settings') ? 'border-b border-[#ed0078] text-[#ed0078]' : '' ?> ">Setări magazin</a>
<a href="/admin/front-page-hero"
    class="<?= urlIs('/admin/front-page-hero') ? 'border-b border-[#ed0078] text-[#ed0078]' : '' ?> ">Hero image</a>
