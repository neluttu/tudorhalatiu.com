...
<main class="w-full px-2 max-w-7xl">
    ...
    <section class="flex flex-wrap items-center justify-center px-2 lg:justify-between lg:px-0">
        <form action="<?= \Core\Session::getLang(); ?>/session" method="post" class="self-start order-2 w-full md:flex-1 md:w-1/2 md:order-1">
            ...
            <div class="relative mt-6">
                <svg xmlns="http://www.w3.org/2000/svg" id="showPassword" class="absolute transition-opacity duration-300 ease-in-out opacity-100 cursor-pointer right-1 top-2 text-main-color" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" onclick="togglePasswordVisibility('password')">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="absolute hidden transition-opacity duration-300 ease-in-out opacity-0 cursor-pointer right-1 top-2 text-main-color" id="hidePassword" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" onclick="togglePasswordVisibility('password')">
            ...
            <script>
                function togglePasswordVisibility(inputId) {
                    ...
                    const hideButton = document.getElementById('hidePassword');
