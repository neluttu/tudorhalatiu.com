        ...
        <div class="relative w-full px-6 pt-10 pb-8 mx-auto bg-white shadow-xl ring-1 ring-gray-900/5 sm:rounded-xl sm:px-10">
            <div class="w-full">
                <div class="text-center">
                    ...
                    <p class="mt-2 text-gray-500">Fill in a new password for your account.</p>
                </div>
                <div class="mt-5">
                    <form action="/reset-password" method="post">
                        ...
                        <div class="my-6">
                            <button type="submit" class="w-full px-3 py-4 text-white bg-black rounded-md focus:bg-gray-600 focus:outline-none">Reset your password</button>
                        </div>
