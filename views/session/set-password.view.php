    ...
    <section class="flex flex-wrap items-center justify-center px-2 lg:justify-between lg:px-0">
        <form method="POST" class="self-start order-2 w-full md:flex-1 md:w-1/2 md:order-1">
            ...
            <div class="relative mt-6">
                <input type="password" name="password" id="password" placeholder="Alege parola nouă" class="w-full px-0 py-1 mt-1 border-b-2 border-gray-200 peer placeholder:text-transparent focus:border-gray-500 focus:outline-none" autocomplete="NA" />
                <label for="password" class="absolute top-0 left-0 text-sm text-gray-800 transition-all duration-100 ease-in-out origin-left transform -translate-y-1/2 opacity-75 pointer-events-none peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500 peer-focus:top-0 peer-focus:pl-0 peer-focus:text-sm peer-focus:text-gray-800">Alege parola nouă</label>
            </div>
            <?=$errors['password'] ?? '' ?>
            <div class="relative mt-6">
                <input type="password" name="password_verify" id="password_verify" placeholder="Confirmă parola nouă" class="w-full px-0 py-1 mt-1 border-b-2 border-gray-200 peer placeholder:text-transparent focus:outline-none" autocomplete="NA" />
                <label for="password_verify" class="absolute top-0 left-0 text-sm text-gray-800 transition-all duration-100 ease-in-out origin-left transform opacity-75 pointer-events-none -translate-y-2/3 peer-placeholder-shown:top-1/3 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500 peer-focus:top-0 peer-focus:pl-0 peer-focus:text-sm peer-focus:text-gray-800">Confirmă parola nouă</label>
